...
namespace FIMSpace.AnimationTools
{
    public partial class AnimationDesignerWindow : EditorWindow
    {
        ...
        {
            if (rootBaker != null) rootBaker.PostAnimator();
            ...
            if (rootBaker != null) rootBaker.PostRootMotion();
        ...
        void LateUpdateSimulation()
        {
            ...
            {
                for (int i = 0; i < Limbs.Count; i++)
                    Limbs[i].IKLateUpdateSimulation(_anim_ikSet.GetIKSettingsForLimb(Limbs[i], S), dt, animationProgress, 1f);
            }
