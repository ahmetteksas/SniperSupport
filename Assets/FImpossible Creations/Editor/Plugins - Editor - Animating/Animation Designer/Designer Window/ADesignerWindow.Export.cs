...
namespace FIMSpace.AnimationTools
{
    public partial class AnimationDesignerWindow : EditorWindow
    {
        ...
        //                    deltaTime = dt;
        //                    BakingPreSimulation();
        //                    yield return new WaitForSecondsRealtime((0.01f / (4f + l * 2f)) * coroMul);
        //                }
        //                else
        //                {
        //                    //UnityEngine.Debug.Log("oversimulates = " + overSimulates + " ratio = " +bakeFramerateRatio);
        ...
        //                deltaTime = dt;
        //                BakingPreSimulation();
        //                yield return new WaitForSecondsRealtime((0.01f / (4f)) * coroMul);
        //            }
        //            else
        //            {
        //                for (int o = 0; o < overSimulates; o++)
        ...
        //        if (bakeFramerateRatio <= 1.05f || i == startKey || i == endKey - 1) // No need for oversimulating
        //        {
        //            animationElapsed = (((float)(i) / (float)(keys - 1)) * _play_mod_Length_PlusJustMul);
        //            deltaTime = dt;
