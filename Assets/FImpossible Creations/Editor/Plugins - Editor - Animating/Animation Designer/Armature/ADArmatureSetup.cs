...
namespace FIMSpace.AnimationTools
{
    ...
    public class ADArmatureSetup
    {
        ...
        internal void Bake_Prepare(Transform anim, AnimationClip originalClip, AnimationDesignerSave save, ADClipSettings_Main main)
        {
            ...
            rootBake = null;
            bake = new ADArmatureBakeHelper(this, originalClip);
            ...
            if (!requestMet)
            {
                ...
                adRef.UseAdditionalFramesLoop = false;
        ...
        internal void Bake_Complete(ref AnimationClip clip, AnimationDesignerSave save, AnimationClip originalClip)
        {
            ...
            if (save.Export_HipsAndLegsPrecisionBoost > 0f)
            {
                ...
                if (PelvisBoneReference.TempTransform.parent != RootBoneReference.TempTransform)
                {
                    ...
                    for (int i = 0; i < BakeBonesSetup.Count; i++)
                    {
                        ...
                        {
                            BakeBonesSetup[i].UseAdditionalFramesLoop = false;
            ...
            else
            {
                ...
                if (save.Export_IncludeRootMotionInKeyAnimation) RootBoneReference.SaveCurvesForClip(ref clip, save.Export_OptimizeCurves * 0.6f, false);
            }
            ...
            bake.SaveHumanoidCurves(ref clip, save.Export_OptimizeCurves);
